...
const de: Catalog = {
  ...
  "vocab.tools": "Werkzeuge",
  "vocab.resourceTypes": "Ressourcentypen",
  "vocab.valueOptional": "Wert optional",
  "vocab.colName": "Name",
  "vocab.colRegex": "Regex",
  "vocab.colActions": "Aktionen",
  "vocab.regexPlaceholder": "Regex (optional)",
  "vocab.newTool": "Neues Werkzeug…",
  "vocab.newResourceType": "Neuer Ressourcentyp (Schlüssel)…",
  "vocab.duplicatePrompt": 'Duplikat von "{name}" – neuer Schlüssel',
